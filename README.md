...
5. `Get-Process | Format-Column -Property ProcessName`
6. `Get-Process | Format-Column -Property {$_.ProcessName}`
7. `Get-Process | Format-Column -Property @{Expression='ProcessName'}`
8. `Get-Process | Format-Column -Property @{Expression={$_.ProcessName}}`
