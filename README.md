...
4. `Get-Process | Format-Column -Property ProcessName`, `Get-Process | Format-Column -Property {$_.ProcessName}`, `Get-Process | Format-Column -Property @{Expression='ProcessName'}`, `Get-Process | Format-Column -Property @{Expression={$_.ProcessName}}`
