...
Optionally, to be able to use the function alias `fcol`, it is also necessary to issue the command `Import-Module -Name FormatColumn` at the PowerShell command prompt after the module file has been copied to the module folder.
## Functions
### Format-Column
#### Syntax
```
